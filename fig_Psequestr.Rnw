...
corplot(phos$P_mic_TDP[phos$days==181]-phos$P_mic_TDP[phos$days==14],hmw.proc$LCI, bg=h3.col, pch=h3.pch, ylab=expression(paste(Delta, "LCI (0-181 days)")), xlab=expression (paste ("P mobilization (0-181 days, ", mu, "g P g-1 d.w.)", sep="")))

legend("bottomleft", typlev, pch=pch, col=colscale)
axis(4)
@
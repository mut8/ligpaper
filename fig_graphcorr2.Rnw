...
xlim=c(min(var1, na.rm=T)-(max(var1, na.rm=T)- min(var1, na.rm=T))*0.1,max(var1, na.rm=T)+(max(var1, na.rm=T)- min(var1, na.rm=T))*0.2)
...
xlim=c(min(var2, na.rm=T)-(max(var2, na.rm=T)- min(var2, na.rm=T))*0.1,max(var2, na.rm=T)+(max(var2, na.rm=T)- min(var2, na.rm=T))*0.2)
ylim=c(min(var4, na.rm=T)-(max(var4, na.rm=T)- min(var4, na.rm=T))*0.1,max(var4, na.rm=T)+(max(var4, na.rm=T)- min(var4, na.rm=T))*0.2)
...
xlim=c(min(var3, na.rm=T)-(max(var3, na.rm=T)- min(var3, na.rm=T))*0.1,max(var3, na.rm=T)+(max(var3, na.rm=T)- min(var3, na.rm=T))*0.2)
ylim=c(min(var4, na.rm=T)-(max(var4, na.rm=T)- min(var4, na.rm=T))*0.1,max(var4, na.rm=T)+(max(var4, na.rm=T)- min(var4, na.rm=T))*0.2)
...
xlim=c(min(var1, na.rm=T)-(max(var1, na.rm=T)- min(var1, na.rm=T))*0.2,max(var1, na.rm=T)+(max(var1, na.rm=T)- min(var1, na.rm=T))*0.1)
...
xlim=c(min(var2, na.rm=T)-(max(var2, na.rm=T)- min(var2, na.rm=T))*0.2,max(var2, na.rm=T)+(max(var2, na.rm=T)- min(var2, na.rm=T))*0.1)
ylim=c(min(var5, na.rm=T)-(max(var5, na.rm=T)- min(var5, na.rm=T))*0.1,max(var5, na.rm=T)+(max(var5, na.rm=T)- min(var5, na.rm=T))*0.2)
...
xlim=c(min(var3, na.rm=T)-(max(var3, na.rm=T)- min(var3, na.rm=T))*0.2,max(var3, na.rm=T)+(max(var3, na.rm=T)- min(var3, na.rm=T))*0.1)
ylim=c(min(var5, na.rm=T)-(max(var5, na.rm=T)- min(var5, na.rm=T))*0.1,max(var5, na.rm=T)+(max(var5, na.rm=T)- min(var5, na.rm=T))*0.2)
...
text(par("xaxp")[2]-(par("xaxp")[2]-par("xaxp")[1])*.15,par("yaxp")[2]-(par("yaxp")[2]-par("yaxp")[1])*-.1, cex=.5, paste("R=", formatC(cor1$estimate, digits=3, format="f"), siglev(cor1$p.value) ))
...
mtext("residual", side=2, las=0, padj=0, cex=.8)
mtext(expression("C:P"[lit:mic]), side=1,  padj=0, cex=.8)
text(par("xaxp")[2]-(par("xaxp")[2]-par("xaxp")[1])*.72,par("yaxp")[2]-(par("yaxp")[2]-par("yaxp")[1])*.05, cex=.5, paste("R=", formatC(cor1$estimate, digits=3, format="f"), siglev(cor1$p.value) ))
...
mtext("residual", side=2, las=0, padj=0, cex=.8)
mtext(expression("C:N"[lit:mic]), side=1,  padj=0, cex=.8)
text(par("xaxp")[2]-(par("xaxp")[2]-par("xaxp")[1])*.85,par("yaxp")[2]-(par("yaxp")[2]-par("yaxp")[1])*-.1, cex=.5, paste("R=", formatC(cor1$estimate, digits=3, format="f"), siglev(cor1$p.value) ))

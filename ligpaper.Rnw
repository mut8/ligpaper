...
cor.colnames<-c("$\\Delta _{L}$", "$\\Delta _{Ch}$", "$\\Delta _{LCI}$", "$L_{\\%loss}$", "$Ch_{\\%loss}$", "$L:C_{\\%loss}$", "$Ch:C_{\\%loss}$", "$L:Ch_{\\%loss}$", "Per:Cell", "Phen:Cell")
...
"C:N mic", "C:P mic", "N:P mic", "C:N(litter:micr)", "C:P(litter:micr)", "N:P(litter:micr)", "Fungi/bacteria(qPCR)")

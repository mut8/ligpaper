...
corr1<-alldata[alldata$days==181,c(10,37, 73,11,14,13,12, 15:16,20,22,24, 39, 57, 40:44, 54:56,  78:80, 76)]
corr2<-hmw.proc
mighty.corr.matrix<-corr.ab(corr1, corr2, tex=T)
#rownames/colnames cor correltion table

cor.colnames<-c("$\\Delta _{L}$", "$\\Delta _{Ch}$", "$\\Delta _{LCIC}$", "$L_{degr}$", "$Ch_{degr}$", "$L:C_{degr}$", "$Ch:C_{degr}$", "$L:Ch_{degr}$", "Per:Cell", "Phen:Cell")
...
corr1<-alldata[alldata$days==475,c(10,37, 73,11,14,13,12, 15:16,20,22,24, 39, 57, 40:44, 54:56,  78:80, 76)]
corr2<-hmw.proc2

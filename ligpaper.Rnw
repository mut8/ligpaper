...
\end{center}
\caption{
{\bf CAPTION} more_caption}
\label{fig:metaprot_pca}
\end{figure*}
...
tab<-corr.ab(cbind(alldata[cond, c(74,37, 34:36, 38:43,50:55,75:77)], metaprot.red[,c(4,6:ncol(metaprot.red))]),scores(ord, display="sites", choices=1:2), tex=T)
table<-xtable(tab, caption="CAPTION", label="ca_tab", align=c("l","l","r"))

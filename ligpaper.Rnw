...
colnames(cor.merge)<-c("Incubtation time","Respiration","NH4 conc.", "NO3 conc.", "PO4 conc", "C litter", "N litter", "P litter", "C:N litter", "C:P litter", "N:P litter", "C micr.", "N micr.", "P micr.", "C:N micr.", "C:P micr.", "N:P micr.", "C:N imbalance", "C:P imbalance", "N:P imbalance",  "F:B prot.", "Dothideomycetes", "Eurotiomycetes", "Leotiomycetes", "Saccharomycetes", "Sordariomycetes", "Agaricomycetes", "Tremellomycetes", "Ustilaginomycetes", "Thermotogae", "Bacteroidetes", "Actinobacteria", "Cyanobacteria", "Firmicutes", "Fusobacteria"     , "Verrucomicrobia", "Dictyoglomi", "Alphaproteobacteria", "Betaproteobacteria", "Gammaproteobacteria", "Deltaproteobacteria", "Epsilonproteobacteria")
tab<-corr.ab(cor.merge,scores(ord, display="sites", choices=1:3), tex=T)
table<-xtable(tab, caption="CAPTION", label="catab", align=c("l","r","r","r"))

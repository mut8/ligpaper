...
plot.meta(ord, arrows=F, envfit=T, enz=F, choices=1:2, lab="CA")

labs<-c("14 days", "97 days", "181 days", "475 days")

legend("bottomleft", pch=pch, pt.bg=1, typlev)
legend("bottomright", pch=21, pt.bg=colscale, labs)

x.positions<-c(0.5, -1.3, 0.05, 2.6)
y.positions<-c(1.55, .7, -1.6, .2 )


text(x.positions, y.positions, labels=labs, cex=0.6)
